  ...
  <div class="student-pass-container">
    ...
    <div class="action-bar print-hidden">
      <div class="action-bar-left">
        ...
        <div>
          <h3 class="pass-title">Official Participation Pass &amp; Entry Badge</h3>
      ...
      <div class="action-bar-right">
        ...
        <button v-if="isModal" type="button" @click="emit('close')" class="close-button">
    ...
    <div class="student-pass-root">
      ...
      <div class="pass-header">
        <div class="pass-header-info">
          ...
          <p class="institution-name">{{ registration.institution }}</p>
        </div>
        ...
        <div class="details-main">
          ...
          <div class="team-leader-grid">
            <div class="detail-box">
              ...
              <p class="detail-value">{{ registration.teamName }}</p>
            </div>

            <div class="detail-box">
              <span class="detail-label">Team Leader</span>
              <p class="detail-value">{{ registration.leaderName || registration.members[0] }}</p>
            </div>
          </div>

          <!-- Track / Domain -->
          <div class="detail-box highlight-box">
            <span class="detail-label highlight-label">Assigned Problem Domain / Track</span>
            <p class="detail-value-mono">{{ registration.track || registration.domain || 'General Track' }}</p>
          </div>
          ...
          <div class="members-box">
            ...
            <div class="members-grid">
              <div v-for="(name, i) in registration.members" :key="i" class="member-item">
                <span class="member-index">{{ String(i + 1).padStart(2, '0') }}</span>
      ...
      <div class="pass-footer">
        ...
        <span class="footer-note">Jaya Engineering College · Carry physical college ID cards to campus.</span>
      </div>
    </div>
  </div>
</template>
