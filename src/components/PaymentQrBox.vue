  ...
  <div class="payment-box">
    ...
    <div class="payment-header">
      <div class="header-left">
        ...
        <div>
          ...
          <span class="header-subtitle">Automated Authentication &amp; Payment Received Verification</span>
        </div>
      </div>
    ...
    <div class="payment-grid" :class="{ 'grid-full': hideQrCode }">
      ...
      <div class="details-column">
        ...
        <div class="secure-card">
          ...
          <p class="secure-desc">
            Scan the QR code with any UPI app or tap one of the direct app buttons below to pay the ₹{{ feeAmount }} challenge fee. Once paid, enter your UPI ID and the 12-digit UTR reference below to verify that payment has been received.
          </p>
        </div>
        ...
        <div class="quick-pay-section">
          ...
          <div class="quick-pay-grid">
            ...
            <a :href="genericUpiUri" class="app-button primary-app-button">
    ...
    <div class="auth-section">
      <div class="auth-header">
        <div class="auth-title-wrapper">
          ...
          <span class="auth-title">
            Payment Authentication &amp; Verification Proof <span class="required-asterisk">*</span>
          </span>
        </div>
      </div>
      ...
      <div class="auth-grid">
        ...
        <div class="input-group">
          ...
          <input
            ...
            class="auth-input"
            :class="userUpiId.trim().length > 3 && userUpiId.includes('@') ? 'input-valid' : ''"
          />
        </div>
      ...
      <p class="security-note">
        ...
        <span>Your UPI ID and 12-digit UTR reference are authenticated and stored to verify that your ₹{{ feeAmount }} registration payment has been received before issuing your official Student ID.</span>
      </p>
    </div>
  </div>
</template>
...
.required-asterisk { color: var(--error); }
...
.status-icon { width: 0.875rem; height: 0.875rem; }
