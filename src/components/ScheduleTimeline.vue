          ...
          <div class="agenda-list">
            <div class="timeline-container">
              ...
              >
                ...
                <div class="timeline-content" :class="{ 'border-b': i !== currentSchedule.agenda.length - 1 }">
...
@media (min-width: 640px) { .section-desc { font-size: 0.875rem; } }
...
.date-icon { width: 1rem; height: 1rem; color: var(--brand-blue); }
...
@media (min-width: 640px) { .event-selector { grid-template-columns: repeat(3, 1fr); } }
...
.event-tab.active .event-tab-venue { color: #38BDF8; }
...
@media (min-width: 640px) { .schedule-content { padding: 2rem; } }

.schedule-grid {
  display: grid;
  gap: 1.5rem;
}
@media (min-width: 1024px) { .schedule-grid { grid-template-columns: 1fr; } }
...
.agenda-header { display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap; }
.agenda-badge {
  display: inline-flex;
  align-items: center;
  gap: 0.375rem;
...
.agenda-badge-icon { width: 0.875rem; height: 0.875rem; color: var(--brand-blue); }
...
@media (min-width: 640px) {
  .agenda-task { margin-top: 0; text-align: right; }
}
...
@media (min-width: 1024px) { .info-column { width: 18rem; } }
...
.info-icon { width: 0.875rem; height: 0.875rem; color: var(--brand-blue); }
