      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#E2E8F0] pb-4 print:hidden">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={handlePrint}
            className="inline-flex items-center gap-1.5 rounded-xl border border-[#0EA5E9] bg-[#FFFFFF] px-4 py-2 text-xs font-semibold text-[#000000] hover:bg-[#F8FAFC] transition-colors shadow-sm"
          >
            <PrinterIcon className="h-3.5 w-3.5 text-[#0EA5E9]" />
          ...
          {isModal && onClose && (
            <button
              type="button"
              onClick={onClose}
              className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-2 text-[#64748B] hover:text-[#000000]"
            >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b-2 border-[#E2E8F0] pb-6">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#0EA5E9] bg-[#F8FAFC] px-3.5 py-1 text-xs font-mono font-bold uppercase tracking-widest text-[#0284C7]">
              <SparklesIcon className="h-3 w-3 text-[#0EA5E9]" />
              <span>Jaya Engineering College · RYVANTA '26 Pass</span>
            </div>
            <h2 className="mt-3 font-serif text-2xl sm:text-3xl font-black text-[#000000]">
          ...
          <div className="rounded-2xl border-2 border-[#0EA5E9] bg-[#F8FAFC] p-4 text-center sm:text-right shadow-sm">
            <span className="block font-mono text-[10px] font-bold uppercase tracking-widest text-[#64748B]">
              Participation ID
            </span>
            <span className="font-mono text-2xl sm:text-3xl font-black text-[#000000] tracking-wider">
              {registration.id}
            </span>
            <span className="mt-1 block font-mono text-[10px] text-[#0284C7] font-bold uppercase">
              ● Verified Admission
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-[minmax(0,1fr)_160px] items-start">
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-3.5">
                ...
                <p className="font-serif text-base font-bold text-[#000000] mt-0.5">
            ...
            <div className="rounded-xl border border-[#0EA5E9]/40 bg-[#F8FAFC] p-3.5">
              <span className="font-mono text-[10px] uppercase font-bold tracking-widest text-[#0284C7]">
                Assigned Problem Domain / Track
              </span>
              <p className="font-mono text-sm font-bold text-[#000000] mt-0.5">
              ...
              <div className="grid gap-2 sm:grid-cols-2 text-xs">
                {registration.members.map((name, i) => (
                  <div key={i} className="flex items-center gap-2 rounded-lg bg-[#FFFFFF] border border-[#E2E8F0] p-2">
                    <span className="flex h-5 w-5 items-center justify-center rounded bg-[#F8FAFC] font-mono text-[10px] font-bold text-[#0EA5E9]">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                    <span className="font-medium text-[#000000] truncate">{name}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] p-4 text-center">
            ...
            <span className="font-mono text-[10px] text-[#000000] font-bold mt-0.5">
              19-09-2026
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 border-t-2 border-[#E2E8F0] pt-4 flex flex-wrap items-center justify-between gap-4 text-xs font-mono text-[#64748B]">
          <div className="flex items-center gap-4">
            <span className="inline-flex items-center gap-1.5 text-[#000000] font-semibold">
