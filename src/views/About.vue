<script setup>
import { UsersIcon, UserIcon, ShieldCheckIcon, GraduationCapIcon } from 'lucide-vue-next'
</script>
    ...
    <div class="committee-grid">
      ...
      <div class="committee-card">
        <div class="image-wrapper">
          <img src="/images/chairman.jpg" alt="Prof.A. Kanagaraj M.A., M.Phil." class="profile-image" />
        </div>
      ...
      <div class="committee-card">
        <div class="image-wrapper">
          <img src="/images/vice-chairman.jpg" alt="Er. K.Navaraj, M.Tech., (Ph.D.)" class="profile-image" />
        </div>
      ...
      <div class="committee-card">
        <div class="image-wrapper">
          <img src="/images/secretary.jpg" alt="Smt. K.Vijaya Kumari, M.A., B.Ed." class="profile-image" />
        </div>
