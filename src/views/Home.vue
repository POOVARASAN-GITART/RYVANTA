  ...
  <div class="home-container">
    ...
    <section class="hero-section">
      <div class="hero-content">
        ...
        <p class="hero-desc">
          RYVANTA '26 takes off on <span class="text-bold">19 September 2026</span> at Jaya Engineering College — an entry fee of <span class="text-brand-bold">₹{{ REGISTRATION_FEE }}</span> per person grants full access to compete and win prizes.
        </p>
        ...
        <div class="hero-actions">
          <button @click="scrollToEvents" class="btn-primary hero-btn">
    ...
    <section id="events-lineup" class="lineup-section" aria-labelledby="lineup-heading">
      <div class="lineup-header">
        <div>
          <span class="lineup-subtitle">
            Technical Arenas
          </span>
        ...
        >
          <div>
            <div class="event-card-title-group">
              <div class="event-icon-wrapper" :class="getEventThemeClass(event.id)">
                <component :is="getIconForEvent(event.id)" class="event-icon" />
              </div>
...
.text-brand-bold { font-weight: 700; color: var(--brand-blue); }
...
.btn-primary:hover .btn-icon-right { transform: translateX(0.25rem); }
...
@media (min-width: 640px) { .lineup-title { font-size: 2.25rem; } }
...
.theme-hackathon, .theme-ctf, .theme-games {
...
.event-icon { width: 1.25rem; height: 1.25rem; }
...
.event-card:hover .event-title { color: var(--brand-blue); }
...
.event-action-icon { width: 0.875rem; height: 0.875rem; }
</style>
